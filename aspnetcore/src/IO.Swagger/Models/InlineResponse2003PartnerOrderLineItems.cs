...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003PartnerOrderLineItems : IEquatable<InlineResponse2003PartnerOrderLineItems>
    { 
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets LineItemStatuses
        /// </summary>
        [Required]
        [DataMember(Name="lineItemStatuses")]
        public List<InlineResponse2003PartnerOrderLineItemStatuses> LineItemStatuses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2003PartnerOrderLineItems {\n");
            ...
            sb.Append("  LineItemStatuses: ").Append(LineItemStatuses).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineResponse2003PartnerOrderLineItems)obj);
        }

        /// <summary>
        /// Returns true if InlineResponse2003PartnerOrderLineItems instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2003PartnerOrderLineItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003PartnerOrderLineItems other)
        {
            ...
            return 
                ...
                (
                    LineItemStatuses == other.LineItemStatuses ||
                    LineItemStatuses != null &&
                    LineItemStatuses.SequenceEqual(other.LineItemStatuses)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (LineItemStatuses != null)
                    hashCode = hashCode * 59 + LineItemStatuses.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(InlineResponse2003PartnerOrderLineItems left, InlineResponse2003PartnerOrderLineItems right)
        {
