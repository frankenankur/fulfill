...
{ 
    ...
    { 
        /// <summary>
        /// Gets or Sets LineItemReference
        /// </summary>
        [Required]
        [DataMember(Name="lineItemReference")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LineItemReference: ").Append(LineItemReference).Append("\n");
        ...
        public bool Equals(Body other)
        {
            ...
            return 
                (
                    LineItemReference == other.LineItemReference ||
                    LineItemReference != null &&
                    LineItemReference.Equals(other.LineItemReference)
                ) && 
                (
                    Status == other.Status ||
                    Status != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + LineItemReference.GetHashCode();
                    if (Status != null)
